...
public class AnalyticsController {
  ...
  @PostMapping("/admin/v1/analytics/jobs")
  @Transactional
  ...
  @GetMapping("/admin/v1/analytics/jobs/{jobId}")
  ...
  @PostMapping("/admin/v1/analytics/jobs/{jobId}/cancel")
  ...
  @GetMapping("/admin/v1/analytics/jobs/{jobId}/items")
  ...
  @GetMapping("/internal/v1/analytics/books/{bookId}/summary")
  ...
  @GetMapping("/internal/v1/analytics/books/{bookId}/excerpts")
